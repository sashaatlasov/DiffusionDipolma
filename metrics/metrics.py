...
class Metric:
    ...
    def __call__(self, gan_model = None,
...
class CriticValuesStats(DataMetric):
    ...
    def evaluate(self, gan_model, gen_data, val_data, **kwargs) -> Tuple[Dict, Dict]:
        """
...
class GeneratorValuesStats(DataMetric):
    ...
    def evaluate(self, gan_model, gen_data, val_data, **kwargs) -> Dict:
        """
